"""
Django settings for denesiper project.
...
SECRET_KEY = 'django-insecure-dm$*h702^8%l6o-gfk9-vvl0ozs20i5j^i*(30q#t5+hynemct'
...
WSGI_APPLICATION = 'denesiper.wsgi.application'
